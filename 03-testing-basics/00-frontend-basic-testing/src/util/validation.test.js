...
//| NB it is common to organize your tests into "test suites"
//| a test suite is created with a special function named "describe"

describe("validateStringNotEmpty()", () => {
  //| NB IMPORTANT you can add inner describe!! you can nest multiple describe() but usually one is enough
